...
public interface ISolicitudServicio {
    ...
    void crearSolicitud ( Cliente cliente, List<Proveedor> proveedores, String descripcion, Estado estado, float costo, String Comentario, Date fechaServicio) throws Exepcion;
    void modificarById (String id,Cliente cliente,List<Proveedor> proveedores, String descripcion, Estado estado, float costo, String comentario, Date fechaServicio ) throws Exepcion;
